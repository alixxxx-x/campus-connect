...
class _AdminChatScreenState extends ConsumerState<AdminChatScreen> {
  ...
  Future<void> _sendMessage() async {
    ...
    try {
      ...
      _controller.clear();
      // Refresh messages
      ref.invalidate(adminChatHistoryProvider(widget.otherUser.id));
  ...
  Widget build(BuildContext context) {
    final messagesAsync = ref.watch(
      adminChatHistoryProvider(widget.otherUser.id),
    );
  ...
  Widget _buildMessageBubble(AdminChatMessage msg, bool isMe) {
    return Align(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isMe ? AdminStyle.primary : Colors.white,
