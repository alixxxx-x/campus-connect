...
class TeacherChatScreen extends ConsumerStatefulWidget {
  ...
  const TeacherChatScreen({super.key, required this.otherUser});
...
class _TeacherChatScreenState extends ConsumerState<TeacherChatScreen> {
  ...
  Future<void> _sendMessage() async {
    ...
    try {
      ...
      _controller.clear();
      // Refresh messages
      ref.invalidate(teacherChatHistoryProvider(widget.otherUser.id));
      ref.invalidate(teacherConversationsProvider);
  ...
  Widget build(BuildContext context) {
    final messagesAsync = ref.watch(
      teacherChatHistoryProvider(widget.otherUser.id),
    );
  ...
  Widget _buildMessageBubble(TeacherChatMessage msg, bool isMe) {
    return Align(
