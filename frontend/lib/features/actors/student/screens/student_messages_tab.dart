...
class StudentMessagesTab extends ConsumerWidget {
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const Text('Start a conversation with a teacher or student'),
    ...
    return ListTile(
      ...
      trailing: Column(
        ...
        children: [
          ...
          if (!lastMsg.isRead &&
              lastMsg.receiverId != otherUser.id) // Simplified unread
            Container(
